...
SCANNET_RECONS = {
    "annotation_path": "data/train/scannet_recons_train_4frames.json",
    "data_path": "/mnt/data1/zhangjiaxin/project/GAP-MLLM-data/data/media",
    "tag": "3d"
}
...
SCANREFER_STAGE1 = {
    "annotation_path": "data/train/scanrefer_train_32frames_stage1.json",
    "data_path": "/mnt/data1/zhangjiaxin/project/GAP-MLLM-data/data/media",
    "tag": "3d"
}

SCANREFER_STAGE2 = {
    "annotation_path": "data/train/scanrefer_train_32frames_stage2.json",
    "data_path": "/mnt/data1/zhangjiaxin/project/GAP-MLLM-data/data/media",
    "tag": "3d"
}
...
data_dict = {
    ...
    "scannet_recons": SCANNET_RECONS,
    "scannet_det": SCANNET_DET,
    "scanrefer": SCANREFER,
    "scanrefer_stage1": SCANREFER_STAGE1,
    "scanrefer_stage2": SCANREFER_STAGE2,
    "scan2cap": SCAN2CAP,
    "spar_234k": SPAR_234K,
